package idn.jaki.aplikasitodogambar
...
import idn.jaki.aplikasitodogambar.databinding.ActivityAddDataBinding
...
class AddDataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddDataBinding.inflate(inflate)
        ...
        binding.btnSave.setOnClickListener {
            binding.run {
                ...
                if (namaUser.isBlank() || kelasUser.isBlank() || alamatUser.isBlank()) {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE
            ...
            val fileRef = firebaseStorage.child(userData?.profile_name + ".jpg")
